...
<div class="flex flex-col items-center justify-center h-full gap-6 text-center px-8 select-none">
	<div class="relative">
		<div
			class="font-heading font-extrabold text-[120px] leading-none tracking-[-0.04em] text-white/[0.04] pointer-events-none"
		>
			404
		</div>
		<div class="absolute inset-0 flex items-center justify-center">
			<div
				class="size-16 rounded-[20px] bg-[var(--card)] border border-[var(--line)] flex items-center justify-center shadow-[0_8px_32px_rgba(0,0,0,.4)]"
			>
				<svg
					width="28"
					height="28"
	...
	<div>
		<div class="font-heading font-bold text-[22px] tracking-[-0.01em] text-[var(--tx)]">
			{label}
		</div>
		{#if detail}
