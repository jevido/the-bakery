...
<div
	class="h-[52px] shrink-0 border-b border-b-[var(--line)] flex items-center gap-[14px] px-5 bg-[var(--topbar)]"
>
	<div class="flex items-center gap-2 text-[14px] min-w-0">
		...
		<span class="text-[var(--tx-3)]">/</span>
		<span class="text-[var(--tx)] font-semibold whitespace-nowrap overflow-hidden text-ellipsis"
			>{crumb}</span
		>
	</div>
	...
	<div
		class="flex items-center gap-2 bg-[var(--card)] border border-[var(--line)] rounded-[9px] px-[11px] py-[6px] w-[230px] text-[var(--tx-3)]"
	>
		<svg
			width="15"
			height="15"
		...
		<span class="ml-auto font-mono-jb text-[10.5px] bg-white/[0.06] px-[5px] py-[1px] rounded-[4px]"
			>⌘K</span
		>
	</div>
