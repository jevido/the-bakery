<script lang="ts">
	...
	// eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unused-vars -- payload kept for signature-compatibility with the formatter prop type
