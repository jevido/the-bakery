...
import { host, hostMetricSample, hostCommand, volume } from '$lib/server/db/schema';
...
export const POST: RequestHandler = async (event) => {
	...
	const { cpuPct, memPct, diskPct, podmanVersion, containerCount, agentVersion, volumes } =
		parsed.data;
