			...
			<div class="p-[18px]">
				<Field {form} name="name">
					<Control>
						{#snippet children({ props })}
							<Label class="block text-[13px] font-semibold text-[var(--tx-2)] mb-[6px]">Guild name</Label>
							<input
								{...props}
				...
				<div class="mt-[14px]">
					<Field {form} name="color">
						<Control>
							{#snippet children({ props })}
								<Label class="block text-[13px] font-semibold text-[var(--tx-2)] mb-[6px]">Color</Label>
				...
				<div class="flex gap-2">
					<input id="invite-code" value={inviteCode ?? ''} readonly class="flex-1 bg-[var(--card-2)] border border-[var(--line-2)] rounded-[8px] px-[13px] py-[10px] font-mono-jb text-[13px] text-[var(--tx-2)]" />
					<button
						type="button"
